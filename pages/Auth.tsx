...
const AuthPage: React.FC<AuthPageProps> = ({ initialView = 'login', onBack }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950 overflow-y-auto no-scrollbar">
      <div className="min-h-full w-full flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md my-8 animate-in fade-in zoom-in-95 duration-300">
          ...
          <button onClick={onBack} className="w-full text-center mt-6 text-slate-500 hover:text-slate-400 text-sm pb-8">
            ← Back to Home
          </button>
        </div>
      </div>
